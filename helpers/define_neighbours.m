...
data.elec = ft_read_sens(fullfile(loaddir, 'brainamp_montage.sfp'));        % this block assigns the electrode positions according to BRAINVISION to the data
...
save(fullfile(loaddir, 'neighbours.mat'), 'neighbours', '-v7.3');            % saves data to HDD
